...
image::{code}/channels/diagrams/class/priority-channel.jpg[alt=Priority Channel Class Diagram,scaledwidth=40%]
...
image::{code}/channels/diagrams/class/rendezvous-channel.jpg[alt=Rendezvous Channel Class Diagram,scaledwidth=40%]
...
image::{code}/channels/diagrams/eip/rendezvous-request-reply.jpg[alt=Rendezvous Request Reply Diagram,scaledwidth=40%]
