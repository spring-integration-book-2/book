...
This section will focus on practical usages for each of the channel implementations discussed earlier. We will focus on configuration using JavaDSL formation. 
