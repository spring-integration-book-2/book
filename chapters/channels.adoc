...
.Publish-subscribe Channel
image::{code}/channels/diagrams/eip/pubsub-channel.jpg[alt=The Publish Subscribe,pdfwidth=50vw]
...
.Data-Typed Channel
image::{code}/channels/diagrams/eip/data-typed-channel.jpg[alt=The Data Typed Channel,pdfwidth=50vw]
...
.Invalid Message Channel
image::{code}/channels/diagrams/eip/invalid-message-channel.jpg[alt=The Invalid Message Channel,pdfwidth=50vw]
