...
.Point-to-Point Channel
image::{code}/channels/point-to-point-channel.jpg[alt=The Point to Point Channel]
...
.Publish-subscribe Channel
image::{code}/channels/pubsub-channel.jpg[alt=The Publish Subscribe]
...
.Dead Letter Channel
image::{code}/channels/dead-letter-channel.jpg[alt=The Dead Letter Channel]
...
.Channel Adapter
image::{code}/channels/channel-adapter.jpg[alt=The Channel Adapter]
...
.Messaging Bridge
image::{code}/channels/messaging-bridge.jpg[alt=The Messaging Bridge]
...
.Guaranteed Delivery
image::{code}/channels/guaranteed-delivery.jpg[alt=Guaranteed Delivery Pattern]
...
image::{code}/channels/eip/load-balancer.jpg[alt=Load Balancing Handlers Diagram]
