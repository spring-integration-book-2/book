...
Messaging is inherently stateless. 

Spring Integration lets you work with the allusion of state by
...
----
include::{code}/flowsroutes/src/main/java/tdgsi/ChatMessage.java[]
----
