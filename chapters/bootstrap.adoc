...
Spring Integration takes the concepts introduced in this chapter - inversion of control, patterns, decoupling - and extends them in a natural way to the realm of messaging andn integration. We'll see that Spring Integration decouples our business logic from the _where_ and _how_ of service integrations in the same way that Spring does for component dependencies.
